...
class App:
    ...
    def __init__(self, window=tk.Tk(), window_title="Camera Class"):
    ...
    def init_gui(self):
        ...
        self.classname_one = simpledialog.askstring("Clasname One", "Enter the name of the first class:",
                                                    parent=self.window)
        self.classname_two = simpledialog.askstring("Clasname Two", "Enter the name of the first class:",
                                                    parent=self.window)
